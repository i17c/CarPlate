...
<div class="header-banner">
		...
		<!-- 服务器版 -->
		 ...
		 <!-- 本地测试版 -->
		 <%-- <img src="D:\usr\local\tomcat\webapps\upload\<%=session.getAttribute("pictureName") %>" alt="" > --%>
</div>
<!-- 点击按钮提交此表单 -->
<!-- <form id="form1" name="form1" action="" method="post">
	<input type="hidden" name="input" value="ceshixingxi"/>
</form> -->

<div class="header-e3para" >
		<div class="nav" >
        <ul>
		...
		<ul>
            ...
            <input type="hidden" value="<%=session.getAttribute("pictureName") %>" class="btn-submit"/>
		...
		<ul>
           <form name="form4" id="form4" action="originalPicture.do" method="post">
            <input type="hidden" value="<%=session.getAttribute("pictureName") %>"/>
            <!-- <li><input type="submit" value="二值化"/></li> -->
